              ...
              <>
                ...
                {!collapsed && (
                  <button
                    ...
                    className="flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-xs text-surface-400 hover:text-surface-200 transition-colors"
                  >
                    <ArrowLeft size={12} />
                    All Projects
                  </button>
                ...
                {projectName && !collapsed && (
                  <div className="px-2 py-1.5">
                    <div className="flex items-center gap-2">
                      <FolderKanban size={16} className="text-brand-300" />
                      <span className="text-sm font-semibold text-[#F2F2F2] truncate">
                        {projectName}
                      </span>
                    </div>
                  </div>
